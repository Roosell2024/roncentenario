  ...
  return (
    <>
      ...
      <main className="relative overflow-hidden">
        ...
        />
        <img src={CurveImg} alt="curve" className={`absolute top-0 left-0 w-full -mt-60 ${location !== '/' ? 'sm:h-[1755px] h-[2100px]': 'sm:h-md:h-[1755px] sm:h-sm:h-[1645px] sm:h-[1415px] h-[2050px]'}`} />
        <Header />
