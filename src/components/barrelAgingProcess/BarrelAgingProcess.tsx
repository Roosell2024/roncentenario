  ...
  return (
    <>
      ...
      <div className="relative text-center mt-10">
        ...
        <p className="absolute 2xl:-left-24 sm:-left-36 left-10 sm:right-auto 2xl:bottom-32 sm:bottom-16 -bottom-10 sm:w-56 text-left text-xl font-bold text-green-300 sm:border-b-2 border-green-300 border-dashed sm:pb-3 after:h-5 after:w-5 after:bg-green-300 sm:after:absolute after:right-0 after:-bottom-[10px] after:rounded-full">
